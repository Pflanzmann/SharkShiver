...
public class IntegrationTest {
    ...
    public void twoPeersExchange() throws SharkException, ShiverDHKeyGenerationException, ShiverGroupSizeException, IOException, ShiverPeerNotVerifiedException, NoSuchAlgorithmException, InvalidKeySpecException, InvalidKeyException, ClassNotFoundException, ShiverNoGroupKeyException, ShiverEncryptionException, ShiverDecryptionException {
        ...
        try (MockedStatic<ASAPCryptoAlgorithms> mockASAPCryptoAlgorithms = Mockito.mockStatic(ASAPCryptoAlgorithms.class)) {
            ...
            byte[] bobDecryptedTestMessageBytes = bobShiverComponent.decryptMessageForGroup(bobGroupId, aliceEncryptedTestMessage);
            String bobDecryptedTestMessageString = new String(bobDecryptedTestMessageBytes);

            Assertions.assertEquals(aliceTestMessageToEncryptString, bobDecryptedTestMessageString);
            System.out.println("Alice original message: " + aliceTestMessageToEncryptString);
            System.out.println("Bob received message: " + bobDecryptedTestMessageString);
            ...
            byte[] aliceDecryptedTestMessageBytes = aliceShiverComponent.decryptMessageForGroup(aliceCreatedGroupId, bobEncryptedTestMessage);
            String aliceDecryptedTestMessageString = new String(aliceDecryptedTestMessageBytes);

            Assertions.assertEquals(bobTestMessageToEncryptString, aliceDecryptedTestMessageString);
            System.out.println("Bob original message: " + bobTestMessageToEncryptString);
            System.out.println("Alice received message: " + aliceDecryptedTestMessageString);
        }
    }
}
